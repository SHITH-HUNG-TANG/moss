...
template<typename T>
class MyString : public MyArray<T> ,public ErrorNumber
{

public:
	MyString() :MyArray<T>::MyArray(10) {}
	// Constructs an empty string, with a length of zero characters. 
	// *default capacity = 10

	MyString(const MyString& str) :MyArray<T>::MyArray(str) {}
	...
	// str.insert(6,str2);      to be question
